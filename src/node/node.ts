...
const localnet: Node = {
  ...
  name: "mxw",
  airDrop:
    "gold damp garlic turn host harbor else bird wrestle quarter surround parrot fan naive burst effort impact hen aware step gym ribbon inform cost",
  kyc: {
    provider:
      "foot increase such wave plunge athlete gentle figure hub reunion transfer marriage rude license champion monkey fan balcony position birth onion circle hint cool",
    issuer:
      "brisk barrel dose panther slice album family math cup cute awesome mechanic pattern rack erupt enforce alcohol wolf boil autumn family avoid brother legal",
    middleware:
      "belt world purchase stick spare one music suggest dentist kit globe save snack sauce liquid face undo select ethics choose august rhythm cycle crucial",
  },
  alias: {
    provider:
      "frost anchor admit engage minute pony half half rival fiction radio oven pizza siren state virtual fiscal urge clap dentist captain pink viable strike",
    issuer:
      "have silly fat resemble radar viable evolve start side path later point wreck annual mesh shoulder attitude own label robot test gossip anxiety year",
    middleware:
      "snap youth depart side mail panel category human popular theme cotton receive club sell rebel matrix box opinion host sand oak century chair silk",
