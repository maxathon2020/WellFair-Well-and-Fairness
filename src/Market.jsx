    ...
    return (
      <div>
        <Table height={420} data={data} loading={loading}>
          ...
          <Column width={120} flexGrow={1} resizable>
            <HeaderCell>Price (MXW)</HeaderCell>
            <Cell dataKey="followers" />
          </Column>

          <Column width={200} flexGrow={1} resizable>
            <HeaderCell>Augmented Reality</HeaderCell>
            <Cell>
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://wellnfair-4eb14.web.app/ar.html"
              >
                AR Look
              </a>
            </Cell>
          ...
          <Column width={200} flexGrow={1} fixed="right">
                ...
                return (
                  <span>
                    <a
                      onClick={() => {
                        Swal.fire({
                          title: "1 Day Prime Delivery",
                          html: "<a>402 Reviews</a>",
        ...
        <br />
        <br />
        <Link className="btn btn-custom2 btn-lg page-scroll" to="/mainDash">
